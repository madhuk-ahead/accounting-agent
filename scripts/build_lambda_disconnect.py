#!/usr/bin/env python3
"""Build Lambda zip for WebSocket disconnect handler."""
...
BUILD_DIR = PROJECT_ROOT / "build" / "disconnect"
DIST_DIR = PROJECT_ROOT / "dist"
ZIP_PATH = DIST_DIR / "disconnect_lambda.zip"
...
def main():
    ...
    src = PROJECT_ROOT / "lambda" / "disconnect.py"
    if not src.exists():
        print(f"Missing {src}", file=sys.stderr)
        sys.exit(1)
    shutil.copy2(src, BUILD_DIR / "disconnect.py")
